...
def main(cfg):
    ...
    obj_paths = glob(os.path.join("./data/ShapeNetCoreV2", '*', '*', 'models', '*.obj'))
    ...
    np.save(os.path.join("./results/runs_sdf", f'samples_dict_{cfg["dataset"]}.npy'), samples_dict)

    np.save(os.path.join("./results/runs_sdf", f'idx_str2int_dict.npy'), idx_str2int_dict)
    np.save(os.path.join("./results/runs_sdf", f'idx_int2str_dict.npy'), idx_int2str_dict)


if __name__=='__main__':
    cfg_path = os.path.join("./config_files", 'extract_sdf.yaml')
